...
void main() {
    ...
    vec2 uvrd = uv - 0.86*ff*vec2(1., 0.) - 0.*344.5*ff*vec2(1., 0.)/u_resolution*2.;
    vec2 uvgd = uv - 0.86*ff*vec2(1., 0.)*1.00;
    vec2 uvbd = uv - 0.86*ff*vec2(1., 0.) + 0.*344.5*ff*vec2(1., 0.)/u_resolution*2.;
